...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/maccummings",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
  ...
  projects: [
    {
      title: "Coastal Grill — Restaurant Website",
      href: "#",
      dates: "2026",
      active: true,
      description:
        "A modern restaurant website with online menu, reservation system, photo gallery, and mobile-first design. Built to convert hungry visitors into paying diners.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
    ...
    {
      title: "Momentum — SaaS Landing Page",
      href: "#",
      dates: "2026",
      active: true,
      description:
        "A high-conversion SaaS landing page with animated feature sections, pricing tables, testimonial carousel, and email capture. Designed to turn visitors into signups.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
    ...
    },
    {
      ...
      active: true,
      description:
        "A multi-vendor price comparison engine for aerospace parts. Searches 8+ vendor portals simultaneously, displays real-time pricing, and exports results to CSV for procurement teams.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Node.js",
    ...
    },
    {
      ...
      active: true,
      description:
        "A local-first AI operations dashboard with glassmorphism UI, Kanban board, real-time chat integration, system health monitoring, and project management. PWA-enabled for mobile access.",
      technologies: [
        "Node.js",
        "JavaScript",
        "WebSocket",
